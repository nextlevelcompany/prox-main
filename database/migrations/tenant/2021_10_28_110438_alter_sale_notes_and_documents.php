...
class AlterSaleNotesAndDocuments extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('sale_notes', function (Blueprint $table) {
            $table->unsignedInteger('user_rel_subscription_plan_id')->default(0)->nullable()->comment('Relacion con suscripciones')->after('document_id');
        });
        Schema::table('documents', function (Blueprint $table) {
            $table->unsignedInteger('user_rel_subscription_plan_id')->default(0)->nullable()->comment('Relacion con suscripciones')->after('sale_note_id');
    ...
    {
        Schema::table('sale_notes', function (Blueprint $table) {
            $table->dropColumn('user_rel_subscription_plan_id');
