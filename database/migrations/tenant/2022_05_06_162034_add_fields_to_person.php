<?php
    ...
    class AddFieldsToPerson extends Migration
    {
        ...
        public function up()
        {
                Schema::create('full_subscription_user_data', function (Blueprint $table) {
                    $table->increments('id');
                ...
                Schema::create('full_subscription_server_data', function (Blueprint $table) {
                    $table->increments('id');
                    $table->unsignedInteger('person_id')->nullable()->default(0);
        ...
        {
            Schema::dropIfExists('full_subscription_user_data');
            Schema::dropIfExists('full_subscription_server_data');
