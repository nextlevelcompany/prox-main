...
class CreateAppFullSubscription extends Migration
{
    /**
     * Run the migrations.
     *
        ...
        if ($subscriptionRow != null) {
            ...
            foreach ($levels as $level) {
                ...
                if ($subscriptionLevelRow === null) {
                    $subscriptionLevelRow = self::getSystemModuleLevelConnection()->insert($level);
    ...
    public function down()
    {
        ...
        if ($subscriptionRow != null) {
            ...
            foreach ($levels as $level) {
                $subscriptionLevelRow = self::getSystemModuleLevelConnection()->where($level)->first();
                if ($subscriptionLevelRow != null) {
                    DB::connection('system')->table('module_levels')->delete($subscriptionLevelRow->id);
                }
            }
            */
