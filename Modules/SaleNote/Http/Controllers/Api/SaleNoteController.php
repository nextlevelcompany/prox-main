...
namespace Modules\SaleNote\Http\Controllers\Api;
...
use Modules\Person\Models\Person as PersonModel;
...
use Modules\SaleNote\Http\Controllers\SaleNoteController as SaleNoteControllerWeb;
    ...
    public function store(Request $request)
    {
        ...
        DB::connection('tenant')->transaction(function () use ($request, $data) {
            ...
            if (key_exists('payments', $data)) {
                $payments = new SaleNoteControllerWeb;
