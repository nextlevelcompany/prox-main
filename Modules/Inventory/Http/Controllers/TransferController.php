...
class TransferController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('tenant.inventory.transfers.form');
    ...
    {
        $items = SearchItemHelper::getItemToTrasferWithSearch($request);
    ...
    {
        return ['items' => SearchItemHelper::getItemToTrasferWithoutSearch($warehouse_id)];
        return [
    ...
    public function getPdf(InventoryTransfer $inventoryTransfer): \Illuminate\Http\Response
    {
        ...
        $pdf = PDF::loadView('tenant.inventory.transfers.export.pdf', compact('data'));
