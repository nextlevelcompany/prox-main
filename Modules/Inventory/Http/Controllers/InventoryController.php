...
use Modules\Inventory\Imports\StockImport;
...
use Modules\Inventory\Http\Requests\MoveRequest;
use Modules\Inventory\Http\Resources\InventoryResourceWithoutSeries;
...
class InventoryController extends Controller
{
    ...
    {
        return view('tenant.inventory.inventory.index');
    }
    ...
    /**
     * 
     * Obtener registro sin series
     *
     * @param  int $id
     * @return ItemWarehouse
     */
    public function recordWithoutSeries($id)
    {
        $record = new InventoryResourceWithoutSeries(ItemWarehouse::with(['item', 'warehouse'])->findOrFail($id));
    ...
    public function move(MoveRequest $request)
    {
        ...
        try {
            ...
            if (!$series) {
                throw new Exception('No se encontraron series para el tipo de documento U4 en el establecimiento.');
            }
