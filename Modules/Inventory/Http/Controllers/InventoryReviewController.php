...
use Modules\Report\Exports\GeneralFormatExport;
use Carbon\Carbon;
...
class InventoryReviewController extends Controller
{
    ...
    {
        return view('tenant.inventory.inventory-review.index');
    }
    ...
    public function export(Request $request)
    {
        ...
        $view = 'tenant.inventory.inventory-review.exports.general_format';
