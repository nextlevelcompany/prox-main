...
//        return view('inventory::reports.inventory.index', compact('reports', 'warehouses'));
        return view('tenant.inventory.reports.inventory.index');
    }
     ...
     * @return Builder
     */
    private function getRecords($warehouse_id = 'all', $filter, $request)
    {
        ...
        if ($request->warehouse_id !== 'all') {
            $query->where('item_warehouse.warehouse_id', $request->warehouse_id);
        }
    ...
    public function search(Request $request)
    {
        ...
        return view('tenant.inventory.reports.inventory.index', compact('reports'));
    }
