...
class UserController extends Controller
{
    ...
    public function store(UserRequest $request)
    {
        ...
        DB::connection('tenant')->transaction(function () use ($request, $id) {
            ...
            $user->change_seller = $request->input('change_seller');
            $user->permission_edit_sale_note = $request->input('permission_edit_sale_note');
    ...
    public function changeActive(Request $request)
    {
        ...
        return [
            'success' => true,
            'message' => $request->active ? 'Usuario inhabilitado' : 'Usuario habilitado',
        ];
    }
