...
use Modules\Item\Models\ItemUnitType;
...
class CatDigemid extends ModelTenant
{
     ...
     * @return CatDigemid
     */
    public function setPrices(string $prices): CatDigemid
    {
        $this->prices = $prices;
        return $this;
    }
     ...
     * @return int
     */
    public function getMaxPrices(): int
    {
     ...
     * @return CatDigemid
     */
    public function setMaxPrices(int $max_prices): CatDigemid
    {
     ...
     * @return CatDigemid
     */
    public function setItemId(int $item_id): CatDigemid
    {
     ...
     * @return string
     */
    public function getCodDigemid(): string
    {
     ...
     * @return CatDigemid
     */
    public function setCodDigemid(string $cod_digemid): CatDigemid
    {
     ...
     * @return CatDigemid
     */
    public function setNomProd(string $nom_prod): CatDigemid
    {
     ...
     * @return string
     */
    public function getConcent(): string
    {
        return $this->concent;
    }
     ...
     * @return CatDigemid
     */
    public function setConcent(string $concent): CatDigemid
    {
     ...
     * @return string
     */
    public function getNomFormFarm(): string
    {
     ...
     * @return CatDigemid
     */
    public function setNomFormFarm(string $nom_form_farm): CatDigemid
    {
     ...
     * @return string
     */
    public function getNomFormFarmSimplif(): string
    {
     ...
     * @return CatDigemid
     */
    public function setNomFormFarmSimplif(string $nom_form_farm_simplif): CatDigemid
    {
     ...
     * @return string
     */
    public function getPresentac(): string
    {
     ...
     * @return CatDigemid
     */
    public function setPresentac(string $presentac): CatDigemid
    {
     ...
     * @return string
     */
    public function getFracciones(): string
    {
     ...
     * @return CatDigemid
     */
    public function setFracciones(string $fracciones): CatDigemid
    {
     ...
     * @return string
     */
    public function getFecVctoRegSanitario(): string
    {
     ...
     * @return CatDigemid
     */
    public function setFecVctoRegSanitario(string $fec_vcto_reg_sanitario): CatDigemid
    {
     ...
     * @return string
     */
    public function getNumRegSan(): string
    {
     ...
     * @return CatDigemid
     */
    public function setNumRegSan(string $num_reg_san): CatDigemid
    {
     ...
     * @return string
     */
    public function getNomTitular(): string
    {
     ...
     * @return CatDigemid
     */
    public function setNomTitular(string $nom_titular): CatDigemid
    {
     ...
     * @return CatDigemid
     */
    public function setActive(bool $active): CatDigemid
    {
        $this->active = $active;
        return $this;
    }
