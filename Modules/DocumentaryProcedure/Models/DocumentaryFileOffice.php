...
class DocumentaryFileOffice extends ModelTenant
{
     ...
     */
    public function setDocumentaryFileId($documentary_file_id = 0): DocumentaryFileOffice
    {
     ...
     * @return DocumentaryFileOffice
     */
    public function setDocumentaryOfficeId($documentary_office_id = 0): DocumentaryFileOffice
    {
     ...
     * @return DocumentaryFileOffice
     */
    public function setDocumentaryActionId($documentary_action_id = 0): DocumentaryFileOffice
    {
     ...
     * @return DocumentaryFileOffice
     */
    public function setObservation($observation = false): DocumentaryFileOffice
    {
     ...
     * @return DocumentaryFileOffice
     */
    public function setStatus($status): DocumentaryFileOffice
    {
        $this->status = $status;
        return $this;
    }
     ...
     * @return DocumentaryFileOffice
     */
    public function setOfficeName(?string $office_name): DocumentaryFileOffice
    {
     ...
     * @return DocumentaryFileOffice
     */
    public function setProcessName(?string $process_name): DocumentaryFileOffice
    {
     ...
     * @return int|null
     */
    public function getDocumentaryProcessId(): ?int
    {
     ...
     * @return DocumentaryFileOffice
     */
    public function setDocumentaryProcessId(?int $documentary_process_id): DocumentaryFileOffice
    {
     ...
     * @return DocumentaryFileOffice
     */
    public function setComplete(?bool $complete): DocumentaryFileOffice
    {
     ...
     * @return DocumentaryFileOffice
     */
    public function setStartDate(?Carbon $start_date): DocumentaryFileOffice
    {
     ...
     * @return DocumentaryFileOffice
     */
    public function setEndDate(?Carbon $end_date): DocumentaryFileOffice
    {
     ...
     * @return DocumentaryFileOffice
     */
    public function setDays(?int $days): DocumentaryFileOffice
    {
        $this->days = $days;
        return $this;
    }
