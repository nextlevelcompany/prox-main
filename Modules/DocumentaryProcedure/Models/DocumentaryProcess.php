...
class DocumentaryProcess extends ModelTenant
{
     ...
     * @return false|int[]
     */
    public function getDocumentaryOffices(): ?array
    {
     ...
     * @return false|int[]
     */
    public function getDocumentaryOfficesOrder(): ?array
    {
     ...
     */
    public function setDescription($description = ''): DocumentaryProcess
    {
     ...
     * @return DocumentaryProcess
     */
    public function setPrice(float $price = 0): DocumentaryProcess
    {
     ...
     * @return DocumentaryProcess
     */
    public function setName($name = ''): DocumentaryProcess
    {
        $this->name = $name;
        return $this;
    }
     ...
     * @return DocumentaryProcess
     */
    public function setDocumentaryOffices(?array $documentary_offices = []): DocumentaryProcess
    {
     ...
     * @return DocumentaryProcess
     */
    public function setDocumentaryOfficesOrder(?array $documentary_offices_order = []): DocumentaryProcess
    {
     ...
     * @return DocumentaryProcess
     */
    public function setActive(bool $active): DocumentaryProcess
    {
