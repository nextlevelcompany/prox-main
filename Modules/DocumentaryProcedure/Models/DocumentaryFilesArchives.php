...
class DocumentaryFilesArchives extends ModelTenant
{
     ...
     */
    public function setUserId($user_id): DocumentaryFilesArchives
    {
     ...
     * @return DocumentaryFilesArchives
     */
    public function setDocumentaryFileId($documentary_file_id): DocumentaryFilesArchives
    {
     ...
     * @return DocumentaryFilesArchives
     */
    public function setDocumentaryOfficeId($documentary_office_id): DocumentaryFilesArchives
    {
     ...
     * @return DocumentaryFilesArchives
     */
    public function setObservation($observation): DocumentaryFilesArchives
    {
     ...
     * @return DocumentaryFilesArchives
     */
    public function setAttachedFile($attached_file): DocumentaryFilesArchives
    {
