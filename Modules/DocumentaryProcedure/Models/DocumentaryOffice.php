...
class DocumentaryOffice extends ModelTenant
{
     ...
     */
    public function setDays(int $days = 0): DocumentaryOffice
    {
        $this->days = (int)$days;
        return $this;
    }
     ...
     * @return DocumentaryOffice
     */
    public function setDescription($description): DocumentaryOffice
    {
     ...
     * @return DocumentaryOffice
     */
    public function setName($name): DocumentaryOffice
    {
