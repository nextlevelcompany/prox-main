...
class DocumentaryFileController extends Controller
{
    ...
    public function index_simplify(Request $request)
    {
        ...
        return view('tenant.documentary_procedure.files_simplify',
            compact(
                'files',
                'processes',
                'documentTypes',
    ...
    public function index_simplify_new(Request $request, $id = 0)
    {
        ...
        $statusDocumentary = DocumentaryGuidesNumberStatus::all();
        $recordid = (int)$id;
        return view('tenant.documentary_procedure.files_simplify_form',
            compact(
                'files',
                'processes',
                'documentTypes',
    ...
    public function pdf(Request $request)
    {
        ...
        */
        ...
        $pdf = PDF::loadView('tenant.documentary_procedure.exports.report_excel',
            compact('records', 'company', 'establishment'))
