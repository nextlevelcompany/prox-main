...
class EcommerceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.ecommerce.index', ['dataPaginate' => $dataPaginate, 'configuration' => $configuration->stock_control]);
    }
    ...
    public function item($id, $promotion_id = null)
    {
        ...
        return view('tenant.ecommerce.ecommerce.items.record', compact('record'));
    }
    ...
    {
        $record = Item::find($id);
        return view('tenant.ecommerce.ecommerce.items.partial', compact('record'));
    }
    ...
    public function detailCart()
    {
        ...
        return view('tenant.ecommerce.ecommerce.cart.detail', compact(['configuration', 'history_records']));
    }
