...
class QuotationController extends Controller
{
    ...
    public function tables()
    {
        ...
        $establishments = Establishment::where('id', $establishment_id)->getDataFromRelatedTables()->get();
        ...
        */
        ...
        return compact('customers', 'establishments', 'currency_types', 'discount_types', 'charge_types', 'configuration',
            'company', 'document_type_03_filter', 'payment_method_types', 'payment_destinations', 'sellers', 'series');
    ...
    {
        $items = SearchItemHelper::getItemsToQuotation();
        $categories = [];
...
//    }
    ...
    {
        $items = SearchItemHelper::getItemsToQuotation($request);
    ...
    public function searchItemById($id)
    {
        ...
        $items = SearchItemHelper::getItemsToQuotation(null, $id);
        return compact('items');
    ...
    public function email(Request $request)
    {
        ...
        $mailable = new QuotationMail($client, $quotation);
        $id = (int)$request->id;
