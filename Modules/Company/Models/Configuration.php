...
class Configuration extends ModelTenant
{
    ...
    public static function setConfigSmtpMail()
    {
        ...
        if (
            ...
            Config::set('mail.from.address', $config->smtp_user);
    ...
    public function getCollectionData()
    {
        ...
        $currency = func_get_table_currency_types();
        $skins = Skin::all();
        return [
            'id' => $this->id,
            'company' => $company,
            ...
            'url_globalfactoring' => config('configuration.url_globalfactoring'),
        ];
    }
    ...
    {
        $api_service_token = \Modules\System\Models\Configuration::getApiServiceToken();
    ...
    {
        return (bool)\Config('extra.subscription_facturalo');
    }
