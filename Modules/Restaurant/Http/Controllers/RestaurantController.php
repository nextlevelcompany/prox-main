...
class RestaurantController extends Controller
{
    public function menu($name = null)
    {
        ...
        return view('tenant.restaurant.index', ['dataPaginate' => $dataPaginate, 'configuration' => $configuration->stock_control])->with('categories', $categories);
    }
    ...
    {
        return view('tenant.restaurant.items.index');
    }
    ...
    public function partialItem($id)
    {
        ...
        return view('tenant.restaurant.items.partial', compact('record'));
    }
    ...
    public function item($id, $promotion_id = null)
    {
        ...
        return view('tenant.restaurant.items.record', compact('record'));
    }
    ...
    public function detailCart()
    {
        ...
        return view('tenant.restaurant.cart.detail', compact(['configuration', 'history_records']));
    }
    ...
    public function paymentCash(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $this->paymentCashMail($customer_email, $document);
    ...
    public function paymentCashMail($customer_email, $document)
    {
        try {
