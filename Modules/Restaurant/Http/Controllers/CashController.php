...
use Modules\Cash\Http\Requests\CashRequest;
use Modules\Cash\Http\Resources\CashCollection;
use Modules\Cash\Http\Resources\CashResource;
...
use Modules\Cash\Exports\CashProductExport;
...
class CashController extends Controller
{
    ...
    {
        return view('tenant.restaurant.cash.index');
    }

    public function posFilter()
    {
        return view('tenant.restaurant.cash.filter_pos');
    }
