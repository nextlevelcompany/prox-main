...
use Modules\Sale\Mail\SaleOpportunityMail;
...
class SaleOpportunityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.sale.sale_opportunities.index', compact('SellerCanGenerateSaleOpportunities'));
    }


    public function create($id = null)
    {
        return view('tenant.sale.sale_opportunities.form', compact('id'));
    }
    ...
    public function email(Request $request)
    {
        ...
        $mailable = new SaleOpportunityMail($client, $sale_opportunity);
