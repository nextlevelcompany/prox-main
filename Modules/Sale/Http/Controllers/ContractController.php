...
use Modules\Sale\Mail\ContractMail;
...
class ContractController extends Controller
{
    ...
    {
        return view('tenant.sale.contracts.index');
    }
    ...
    public function create($id = null)
    {
        ...
        return view('tenant.sale.contracts.form', compact('id', 'quotationId', 'showPayments'));
    }
    ...
    public function email(Request $request)
    {
        ...
        $mailable = new ContractMail($client, $contract);
        $id = (int)$contract->id;
    ...
    {
        $items = SearchItemHelper::getItemToContract(null, $id);
    ...
    {
        $items = SearchItemHelper::getItemToContract($request);
        return compact('items');
    }
}
