...
namespace Modules\OrderForm\Http\Controllers;
...
use Modules\OrderForm\Http\Requests\OrderFormRequest;
use Modules\OrderForm\Http\Resources\OrderFormCollection;
use Modules\OrderForm\Http\Resources\OrderFormResource;
use App\Http\Controllers\Controller;
use Modules\Catalog\Models\IdentityDocumentType;
use Modules\Catalog\Models\TransferReasonType;
use Modules\Catalog\Models\TransportModeType;
...
use Modules\OrderForm\Mail\OrderFormEmail;
...
class OrderFormController extends Controller
{
    ...
    {
        return view('tenant.order.order_forms.index');
    }
    ...
    {
        return view('tenant.order.order_forms.form', compact('id'));
    }

    public function dispatchCreate($order_form_id)
    {
        return view('tenant.order.order_forms.create', compact('order_form_id'));
    }
    ...
    public function toPrint($external_id, $format)
    {
        ...
        */
        ...
        return response()->file($temp, $this->generalPdfResponseFileHeaders($order_form->filename));
    }
