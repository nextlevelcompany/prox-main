...
class CashReportController extends Controller
{
    ...
    public function generalCashReportWithPayments($cash_id)
    {
        ...
        return $this->generalToPrintReport(
            'tenant.pos.pos.cash.reports.general_cash_report_payments_pdf',
    ...
    public function reportPaymentsAssociatedCash($cash_id)
    {
        ...
        return $this->generalToPrintReport(
            'tenant.pos.pos.cash.reports.report_payments_associated_cash_pdf',
    ...
    public function reportSummaryDailyOperations($cash_id)
    {
        ...
        return $this->generalToPrintReport('tenant.pos.pos.cash.reports.report_summary_daily_operations_pdf', 'report_summary_daily_operations', $filename, $pdf_data);
    }
