...
use Modules\Report\Mail\DocumentMail;
use Mpdf\Mpdf;
...
class ReportDocumentController extends Controller
{
    ...
    public function email(Request $request) {
        ...
        $mailable = new DocumentMail($company, $this->getPdf($data,$columns), $this->getExcel($data,$columns));
        $sendIt = MailHelper::SendMail($email, $mailable);
