    ...
    Route::domain($current_hostname->fqdn)->group(function () {
        Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
            ...
            Route::prefix('reports')->group(function () {
                ...
                Route::prefix('consistency-documents')->group(function () {
                    Route::get('/', 'ReportConsistencyDocumentController@index')->name('tenant.consistency-documents.index')->middleware('tenant.internal.mode');
                    Route::post('/lists', 'ReportConsistencyDocumentController@lists');
                });
