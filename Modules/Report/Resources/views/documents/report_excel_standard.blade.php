<?php
    ...
    $enabled_sales_agents = \Modules\Company\Models\Configuration::getRecordIndividualColumn('enabled_sales_agents');
?>
<!DOCTYPE html>
<html lang="es">
<head>
            ...
            <table class="">
                ...
                @foreach($records as $key => $value)
                    ...
                    <tr>
                        ...
                        @php
                            $customer = \Modules\Person\Models\Person::find($value->customer_id);
                        @endphp
