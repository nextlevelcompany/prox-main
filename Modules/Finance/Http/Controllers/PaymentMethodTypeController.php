...
class PaymentMethodTypeController extends Controller
{
    ...
    public function index(){
      ...
      return view('tenant.finance.payment_method_types.index', compact('configuration'));
    }
    ...
    public function pdf(Request $request) {
        ...
        $pdf = PDF::loadView('tenant.finance.payment_method_types.report_pdf', compact("records", "company", "establishment"));
