...
use Modules\Account\Exports\AccountsReceivable;
...
class UnpaidController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.finance.unpaid.index',compact('configuration'));
    }
    ...
    public function pdf(Request $request) {
        ...
        $pdf = PDF::loadView('tenant.finance.unpaid.reports.report_pdf', compact("records", "company"));
