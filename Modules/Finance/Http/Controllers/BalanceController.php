...
class BalanceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.finance.balance.index', compact('configuration'));
    }
    ...
    public function pdf(Request $request)
    {
        ...
        $pdf = PDF::loadView('tenant.finance.balance.report_pdf', compact('records', 'company', 'establishment', 'data'));
