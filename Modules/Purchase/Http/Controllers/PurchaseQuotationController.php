...
use Modules\Purchase\Mail\PurchaseQuotationMail;
use Mpdf\Mpdf;
...
class PurchaseQuotationController extends Controller
{
    ...
    {
        return view('tenant.purchase.purchase-quotations.index');
    }


    public function create($id = null)
    {
        return view('tenant.purchase.purchase-quotations.form', compact('id'));
    }
    ...
    {
        $items = SearchItemHelper::getItemToPurchaseQuotation();
    ...
    public function toPrint($external_id, $format)
    {
        ...
        */
        ...
        return response()->file($temp, $this->generalPdfResponseFileHeaders($purchase_quotation->filename));
    }
    ...
    public function email($purchase_quotation)
    {
        ...
        foreach ($suppliers as $supplier) {
            ...
            $mailable = new  PurchaseQuotationMail($client, $purchase_quotation);
    ...
    {
        $items = SearchItemHelper::getItemToPurchaseQuotation(null, $id);
    ...
    {
        $items = SearchItemHelper::getItemToPurchaseQuotation($request);
