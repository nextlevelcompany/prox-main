...
use Modules\Catalog\Models\RelatedDocumentType;
...
use Modules\Dispatch\Http\Requests\DispatchRequest;
use Modules\Dispatch\Http\Resources\DispatchCollection;
...
use Modules\Order\Mail\DispatchMail;
...
class DispatchController extends Controller
{
    ...
    public function data_table()
    {
        $customers = Person::whereType('customers')->orderBy('name')->take(20)->get()->transform(function ($row) {
            return [
                'id' => $row->id,
                'search_full_name' => $row->search_full_name,
    ...
    public function create($document_id = null, $type = null, $dispatch_id = null)
    {
        ...
        return view('tenant.dispatches.form', compact('document', 'items', 'type', 'dispatch', 'parentTable', 'parentId'));
    }
...
//            }
    ...
    public function email(Request $request)
    {
        ...
        $mailable = new DispatchMail($record);
        $id = $request->input('id');
        $model = __FILE__ . ";;" . __LINE__;
        $sendIt = MailHelper::SendMail($email, $mailable, $id, 4);
        /*
