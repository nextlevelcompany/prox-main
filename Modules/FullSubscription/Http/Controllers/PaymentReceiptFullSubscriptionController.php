...
class PaymentReceiptFullSubscriptionController extends FullSubscriptionController
{
    ...
    {
        return view('tenant.full_subscription.edit');
    }
    ...
    public function index()
    {
        ...
        return view('tenant.full_subscription.payment_receipt.index', compact('soap_company'));
    }
