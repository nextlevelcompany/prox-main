...
use Modules\Document\Http\Controllers\DocumentPaymentController;
use Modules\Document\Http\Requests\DocumentPaymentRequest;
...
use Modules\Payment\Models\PaymentLinkType;
use Modules\Payment\Traits\PaymentLinkTrait;
use Modules\Payment\Http\Resources\PaymentLinkCollection;
use Modules\Payment\Http\Resources\PaymentLinkResource;
...
class PaymentLinkController extends Controller
{
    ...
    {
        return view('tenant.payment.payment_links.index');
    }
    ...
    public function publicPaymentLink($uuid, $payment_link_type_id, $input_total)
    {
        ...
        return view('tenant.payment.payment_links.public.index', compact('payment_link', 'company', 'payment_configuration', 'total', 'apply_conversion'));
    }
    ...
    public function email(Request $request)
    {
        ...
        Mail::to($request->customer_email)->send(new PaymentLinkMail($company, $request->user_payment_link));
