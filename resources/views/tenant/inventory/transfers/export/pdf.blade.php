...
<head>
    ...
    <meta http-equiv="X-UA-Compatible"
          content="ie=edge">
    <title>Reporte</title>
    @include('tenant.inventory.transfers.export.partial.style')
...
@if($newInventory->count()>0)
    ...
    @foreach ($newInventory as $invIndex => $inventories)
        @include('tenant.inventory.transfers.export.partial.header')

        <br>
        @include('tenant.inventory.transfers.export.partial.items')
