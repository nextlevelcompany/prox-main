...
<body>
    <div class="page-wrapper">
        ...
        @include('tenant.ecommerce.ecommerce.layouts.partials_ecommerce.header')
        <main class="main">
            ...
            <div class="container">
                <div class="row">
                    ...
                    @endphp
                        ...
                        @if(!$tagid)
                            @include('tenant.ecommerce.ecommerce.layouts.partials_ecommerce.home_slider')
                        @endif
                        ...
                        {{-- @include('tenant.ecommerce.ecommerce.layouts.partials_ecommerce.featured_products') --}}
                        <div class="row row-sm">
                            @include('tenant.ecommerce.ecommerce.layouts.partials_ecommerce.list_products')
                        </div>
                    ...
                    <aside class="sidebar-home col-lg-3 order-lg-first">
                        <div class="side-menu-container">
                            <h2>CATEGORIAS</h2>
                            @include('tenant.ecommerce.ecommerce.layouts.partials_ecommerce.sidemenu')
                   ...
                   <div class="widget-banners-slider owl-carousel owl-theme">
                    ...
                    @endforelse
                        ...
                        {{-- <div class="widget widget-testimonials">
                            @include('tenant.ecommerce.ecommerce.layouts.partials_ecommerce.testimonials')
                        </div> --}}
                        <!-- End .widget -->
        ...
        <footer class="footer">
            @include('tenant.ecommerce.ecommerce.layouts.partials_ecommerce.footer')
        </footer><!-- End .footer -->
    ...
    <div class="mobile-menu-container">
        ...
        @include('tenant.ecommerce.ecommerce.layouts.partials_ecommerce.mobile_menu')
