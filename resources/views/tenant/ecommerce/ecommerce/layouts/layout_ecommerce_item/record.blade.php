...
<body>
    <div class="page-wrapper">
        ...
        @include('tenant.ecommerce.ecommerce.layouts.partials_ecommerce.header_bottom_sticky')
        ...
        <main class="main">
            ...
            <div class="container">
                <div class="row">
                    ...
                    @include('tenant.ecommerce.ecommerce.layouts.partials_ecommerce.sidebar_product_right')
                </div><!-- End .row -->
            </div><!-- End .container -->

            <div class="featured-section">
                @include('tenant.ecommerce.ecommerce.layouts.partials_ecommerce.featured_products_bottom' )
