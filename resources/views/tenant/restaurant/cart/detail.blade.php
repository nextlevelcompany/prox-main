@extends('tenant.restaurant.layouts.cart.index')
@section('content')
                    ...
                    <tr>
                        <td colspan="4" class="clearfix">
                            <div class="float-left">
                                <a href="/menu" class="btn btn-outline-secondary">Continuar Comprando</a>
                            </div><!-- End .float-left -->
    ...
    var app_cart = new Vue({
        ...
        methods: {
            async changeExchangeRate(exchange_rate_date){
                var response = await axios.get(`/exchange_rate/ecommerce/${exchange_rate_date}`)
