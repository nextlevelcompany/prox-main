                                    ...
                                    <table class="">
                                        ...
                                        <tr style="background-color: #ebebeb;">
                                            ...
                                            @if ($columns->user_seller->visible)
                                                <th style="padding: 5px; text-align: center;" class="">
                                                    Usuario/Vendedor
                                                </th>
                                            @endif
                                            ...
                                            @if ($columns->payment_form->visible)
                                                <th style="padding: 5px; text-align: center;" class="">Forma de pago
                                                </th>
                                            @endif
                                            ...
                                            @if ($document_types[$c]->id==$document_type->id)
                                                @if ($serie_type['number']==$value->series)
                                                    <tr>
                                                        ...
                                                        @endif
                                                        <td style="padding: 5px; text-align: center;"
                                                            class="celda">{{$document_type->id}}</td>
                                                        <td style="padding: 5px; text-align: center;"
                                                            class="celda">{{$value->series}}</td>
                                                        <td style="padding: 5px; text-align: center;"
                                                            class="celda">{{$value->number}}</td>
                                                        <td style="padding: 5px; text-align: center;"
                                                            class="celda">{{$value->date_of_issue->format('Y-m-d')}}</td>
                                                        <td style="padding: 5px; text-align: center;"
                                                            class="celda">{{isset($value->invoice) ? $value->invoice->date_of_due->format('Y-m-d'):''}}</td>
                                                        ...
                                                        @if ($columns->quote->visible)
                                                            <td style="padding: 5px; text-align: center;"
                                                                class="celda">{{ ($value->quotation) ? $value->quotation->number_full : '' }}</td>
                                                        @endif
                                                        @if ($columns->case->visible)
                                                            <td style="padding: 5px; text-align: center;"
                                                                class="celda">{{ isset($value->quotation->sale_opportunity) ? $value->quotation->sale_opportunity->number_full : '' }}</td>
                                                        @endif
                                                        ...
                                                        @if ($columns->district->visible)
                                                            <td style="padding: 5px; text-align: center;"
                                                                class="celda">{{$stablihsment['district']}}</td>
                                                        @endif
                                                        @if ($columns->department->visible)
                                                            <td style="padding: 5px; text-align: center;"
                                                                class="celda">{{$stablihsment['department']}}</td>
                                                        @endif
                                                        @if ($columns->province->visible)
                                                            <td style="padding: 5px; text-align: center;"
                                                                class="celda">{{$stablihsment['province']}}</td>
                                                        @endif
                                                        @if ($columns->client_direction->visible)
                                                            <td style="padding: 5px; text-align: center;"
                                                                class="celda">{{$value->customer->address}}</td>
                                                        @endif
                                                        <td style="padding: 5px; text-align: center;"
                                                            class="celda">{{$value->customer->name}}</td>
                                                        @if ($columns->ruc->visible)
                                                            <td style="padding: 5px; text-align: center;"
                                                                class="celda">{{$value->customer->number}}</td>
                                                        @endif
                                                        <td style="padding: 5px; text-align: center;"
                                                            class="celda">{{$value->state_type->description}}</td>
                                                        ...
                                                        @if ($columns->currency_type_id->visible)
                                                            <td style="padding: 5px; text-align: center;"
                                                                class="celda">{{$value->currency_type_id}}</td>
                                                        @endif
                                                        ...
                                                        @if ($columns->purchase_order->visible)
                                                            <td style="padding: 5px; text-align: center;"
                                                                class="celda">{{$value->purchase_order}}</td>
                                                        @endif
                                                        ...
                                                        @if($value->sale_note)
                                                            @if ($columns->note_sale->visible)
                                                                <td style="padding: 5px; text-align: center;"
                                                                    class="celda">{{ $value->sale_note->number_full }}</td>
                                                            @endif
                                                            @if ($columns->date_note->visible)
                                                                <td style="padding: 5px; text-align: center;"
                                                                    class="celda">{{ $value->sale_note->date_of_issue->format('Y-m-d') }}</td>
                                                            @endif
                                                        @else
                                                            @if ($columns->note_sale->visible)
                                                                <td style="padding: 5px; text-align: center;"
                                                        ...
                                                        @if($signal == '07')
                                                            ...
                                                            @else
                                                                @if ($columns->total_charge->visible)
                                                                    <td style="padding: 5px; text-align: center;"
                                                                        class="celda">{{$signal == '07' ? "-" : ""  }}{{$value->total_charge}}</td>
                                                                @endif
                                                                @if ($columns->total_exonerated->visible)
                                                                    <td style="padding: 5px; text-align: center;"
                                                                        class="celda">{{$signal == '07' ? "-" : ""  }}{{$value->total_exonerated}}</td>
                                                                @endif
                                                                @if ($columns->total_unaffected->visible)
                                                                    <td style="padding: 5px; text-align: center;"
                                                                        class="celda">{{$signal == '07' ? "-" : ""  }}{{$value->total_unaffected}}</td>
                                                                @endif
                                                                @if ($columns->total_free->visible)
                                                                    <td style="padding: 5px; text-align: center;"
                                                                        class="celda">{{$signal == '07' ? "-" : ""  }}{{$value->total_free}}</td>
                                                                @endif
                                                                @if ($columns->total_taxed->visible)
                                                                    <td style="padding: 5px; text-align: center;"
                                                                        class="celda">{{$signal == '07' ? "-" : ""  }}{{$value->total_taxed}}</td>
                                                                @endif

                                                                <td style="padding: 5px; text-align: center;"
                                                                    class="celda">{{$value->total_discount}}</td>
                                                                @if ($columns->total_igv->visible)
                                                                    <td style="padding: 5px; text-align: center;"
                                                                        class="celda">{{$signal == '07' ? "-" : ""  }}{{$value->total_igv}}</td>
                                                                @endif

                                                                @if ($columns->total_isc->visible)
                                                                    <td style="padding: 5px; text-align: center;"
                                                                        class="celda">{{$signal == '07' ? "-" : ""  }}{{$value->total_isc}}</td>
                                                                @endif
                                                                @if ($columns->total->visible)
                                                                    <td style="padding: 5px; text-align: center;"
                                                                        class="celda">{{$signal == '07' ? "-" : ""  }}{{$value->total}}</td>
                                                                @endif
                                                        ...
                                                        @else
                                                            @if ($columns->total_charge->visible)
                                                                <td style="padding: 5px; text-align: center;"
                                                                    class="celda">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : $value->total_charge}}</td>
                                                            @endif
                                                            @if ($columns->total_exonerated->visible)
                                                                <td style="padding: 5px; text-align: center;"
                                                                    class="celda">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : $value->total_exonerated}}</td>
                                                            @endif

                                                            @if ($columns->total_unaffected->visible)
                                                                <td style="padding: 5px; text-align: center;"
                                                                    class="celda">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : $value->total_unaffected}}</td>
                                                            @endif

                                                            @if ($columns->total_free->visible)
                                                                <td style="padding: 5px; text-align: center;"
                                                                    class="celda">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : $value->total_free}}</td>
                                                            @endif

                                                            @if ($columns->total_taxed->visible)
                                                                <td style="padding: 5px; text-align: center;"
                                                                    class="celda">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : $value->total_taxed}}</td>
                                                            @endif

                                                            <td style="padding: 5px; text-align: center;"
                                                                class="celda">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : $value->total_discount}}</td>
                                                            @if ($columns->total_igv->visible)
                                                                <td style="padding: 5px; text-align: center;"
                                                                    class="celda">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : $value->total_igv}}</td>
                                                            @endif

                                                            @if ($columns->total_isc->visible)
                                                                <td style="padding: 5px; text-align: center;"
                                                                    class="celda">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : $value->total_isc}}</td>
                                                            @endif
                                                            @if ($columns->total->visible)
                                                                <td style="padding: 5px; text-align: center;"
                                                                    class="celda">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : $value->total}}</td>
                                                            @endif
