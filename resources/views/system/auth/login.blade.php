...
@section('content')
    ...
    <section class="body-sign">
        <div class="center-sign">
            <div class="card">
                <div class="card-header card-primary" style="background:rgba(64,81,137)">
                    <p class="card-title text-center">Acceso al Sistema</p>
                    <h1 class="display-1 position-absolute text-left font-weight-bold" style="left: 90%; margin-top: -61px; color: rgba(255,255,255,.1);">X</h1>
                </div>
                <div class="card-body">
            ...
            <p class="text-center text-muted mt-3 mb-3">&copy; Copyright {{ date('Y') }} PRO X. Todos los derechos reservados</p>
        </div>
    </section>
