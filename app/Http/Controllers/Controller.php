...
class Controller extends BaseController
{
    ...
    /**
     *
     * Obtener data de establecimiento para formularios de creacion de registros
     *
     * @return Collection
     */
    public function generalGetEstablishmentForTables()
    {
        return Establishment::where('id', auth()->user()->establishment_id)->getDataFromRelatedTables()->get();
    }
