@php
    ...
    $accounts = (new TemplatePdf)->getBankAccountsForPdf();
...
<table class="full-width">
    ...
    <tr>
        ...
        <td><p class="text-uppercase" style="font-size: 14px"><b>{{ $customer->name }}</b></p></td>
    </tr>
    <tr>
        <td><p class="">{{ $customer->identity_document_type->description }}:</p></td>
        <td><p class="text-uppercase"  style="font-size: 14px"><b>{{ $customer->number }}</b></p></td>
    </tr>
    @if ($customer->address !== '')
        <tr>
            <td class="align-top"><p class="">Dirección:</p></td>
            <td>
                <p class="text-uppercase" style="font-size: 14px">
                    <b>
                        {{ $customer->address }}
...
<table class="full-width mt-10 mb-10">
    ...
    @foreach($document->items as $row)
        <tr>
            ...
            <td style="font-size:12px;" class="text-left align-top font-bold">
            ...
            <td style="font-size:12px;" class="text-right align-top font-bold">{{ number_format($row->unit_price, 2) }}</td>
...
<table class="full-width">
    ...
    <tr>
        <td colspan="2" class="text-center desc pt-2">Para consultar el comprobante ingresar a {!! url('/buscar') !!}
            <br>
            <strong>Sistema de Facturación Electrónica distribuido por www.awsperutic.com</strong>
            <br>
            <strong>Contacto: ventas@awsperutic.com / 916511757</strong>
        </td>
    </tr>
</table>
<table class="full-width">
    ...
    @if(\Modules\Company\Models\Configuration::first()->isLegendFooter())
        <tr>
