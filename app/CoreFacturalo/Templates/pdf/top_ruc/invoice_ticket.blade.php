@php
    ...
    $accounts = \Modules\Bank\Models\BankAccount::PrintShowInDocuments()->get();
...
<table class="full-width">
    ...
    @endif
    <tr>
        <td class="text-center desc pt-5">Para consultar el comprobante ingresar a {!! url('/buscar') !!}<br>
