<?php
use App\CoreFacturalo\Helpers\Template\TemplateHelper;use Modules\Company\Models\Company;
use Modules\Document\Models\Document;use Modules\Document\Models\DocumentItem;use App\Models\Tenant\PaymentMethodType;use Illuminate\Database\Eloquent\Collection;
/**
...
//calculate items
$allowed_items = 94 - (\Modules\Bank\Models\BankAccount::all()->count()) * 2;
