@php
    ...
    $document_type_driver = IdentityDocumentType::findOrFail($document->driver->identity_document_type_id);
    $document_type_dispatcher = IdentityDocumentType::findOrFail($document->dispatcher->identity_document_type_id);
